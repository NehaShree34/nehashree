...
function Component(arg0: { selector: string; templateUrl: string; styleUrls: string[]; }): (target: typeof ImageGridComponent, context: ClassDecoratorContext<typeof ImageGridComponent>) => void | typeof ImageGridComponent {
